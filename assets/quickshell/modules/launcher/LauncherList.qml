    ...
    Rectangle {
      ...
      Rectangle {
        ...
        BorderRect {
          id: border
          color: "transparent"
          borderColor: root.sourceModel.length === 0 ? Style.colors.gray3 : Style.colors.black
          ...
          Quad {
            ...
            strokeColor: root.sourceModel.length === 0 ? Style.colors.gray3 : Style.colors.black
