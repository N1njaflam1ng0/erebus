...
Item {
  ...
  states: [
    ...
    State {
      ...
      when: root.isCurrentItem && !mouseArea.pressed && (mouseArea.containsMouse || actionsArea.hovered)
      PropertyChanges { card.color: Style.colors.gray1 }
      // PropertyChanges { card.border.color: Style.colors.gray6 }
    },
    ...
    State {
      ...
      PropertyChanges { card.color: Style.colors.gray1 }
      PropertyChanges { drawer.border.color: Style.colors.white }
    },
      ...
      sourceComponent: Button {
        ...
        states: [
          State {
            ...
            PropertyChanges { closeRect.border.color: Style.colors.gray6 }
            PropertyChanges { closeContent.color: Style.colors.white }
          }
        ]
        transitions: [
          Transition {
                ...
                Button {
                  ...
                  states: [
                    State {
                      ...
                      PropertyChanges {
                        actionBg.color: Style.colors.gray3
                        actionText.color: Style.colors.white
                      }
                    }
                  ]
                  transitions: [
